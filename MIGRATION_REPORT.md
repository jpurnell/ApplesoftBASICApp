# Migration Report — ApplesoftBASICApp

Migrated to the v2 layout on 2026-08-04.

- Files in the pre-migration tree: 51
- Project documents repatriated to `project/`: 2
- Pre-migration tree preserved at: `development-guidelines.pre-v2/` (gitignored)
- Master plan: **UNFILLED TEMPLATE (16 placeholders)** — `project/master_plan.md` is still the shipped template. The `status` checker reads this file; fill it in.
